...
public class ReservaController {
    ...
    private void reservar() {
        ...
        if (sucesso) {
            ...
            alerta.setContentText("Reserva criada com sucesso!");
        } else {
            alerta = new Alert(Alert.AlertType.ERROR);
            alerta.setContentText("Não foi possível criar a reserva. Verifique as datas e a disponibilidade do quarto.");
        }
        alerta.show();
    }
}